...
class ChatPermissions extends BaseType implements JsonSerializable
{
    ...
    public static function make(
        ...
        $instance = new self;
        $instance->can_send_messages = $can_send_messages;
        $instance->can_send_audios = $can_send_audios;
        $instance->can_send_documents = $can_send_documents;
        $instance->can_send_photos = $can_send_photos;
        $instance->can_send_videos = $can_send_videos;
        $instance->can_send_video_notes = $can_send_video_notes;
        $instance->can_send_voice_notes = $can_send_voice_notes;
        $instance->can_send_polls = $can_send_polls;
        $instance->can_send_other_messages = $can_send_other_messages;
        $instance->can_add_web_page_previews = $can_add_web_page_previews;
