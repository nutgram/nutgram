...
class KeyboardButtonRequestChat extends BaseType implements JsonSerializable
{
    ...
    public static function make(
        ...
        $instance->chat_is_channel = $chat_is_channel;
        $instance->chat_is_forum = $chat_is_forum;
        $instance->chat_has_username = $chat_has_username;
        $instance->chat_is_created = $chat_is_created;
        $instance->user_administrator_rights = $user_administrator_rights;
        $instance->bot_administrator_rights = $bot_administrator_rights;
        $instance->bot_is_member = $bot_is_member;
        $instance->request_title = $request_title;
        $instance->request_username = $request_username;
        $instance->request_photo = $request_photo;
