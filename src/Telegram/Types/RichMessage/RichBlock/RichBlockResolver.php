...
class RichBlockResolver extends ConcreteResolver
{
    protected array $concretes = [
        ...
        RichBlockType::EXPANDABLE_BLOCKQUOTE->value => RichBlockExpandableBlockQuotation::class,
        ...
        RichBlockType::BUTTONS->value => RichBlockButtons::class,
        RichBlockType::ANIMATION->value => RichBlockAnimation::class,
        RichBlockType::AUDIO->value => RichBlockAudio::class,
        RichBlockType::DOCUMENT->value => RichBlockDocument::class,
