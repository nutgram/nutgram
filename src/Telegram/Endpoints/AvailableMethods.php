...
trait AvailableMethods
{
    ...
    {
        // TODO: $parameters = array_filter(compact('file_id'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'user_id', 'only_if_banned'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'user_id', 'custom_title'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'sender_chat_id'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'invite_link'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'user_id'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'photo'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'title'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'description'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'message_id', 'disable_notification'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'message_id'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'sticker_set_name'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'message_thread_id'));
    ...
    {
        // TODO: $parameters = array_filter(compact('chat_id', 'name'));
    ...
    {
        // TODO: $parameters = array_filter(compact('scope', 'language_code'));
    ...
    {
        // TODO: $parameters = array_filter(compact('language_code'));
    ...
    {
        // TODO: $parameters = array_filter(compact('name', 'language_code'));
    ...
    {
        // TODO: $parameters = array_filter(compact('description', 'language_code'));
    ...
    {
        // TODO: $parameters = array_filter(compact('short_description', 'language_code'));
