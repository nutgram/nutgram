...
trait Stickers
{
    ...
    {
        return $this->prepareAndSendRequest(__FUNCTION__, get_defined_vars(), StickerSet::class);
    }
    ...
    {
        return $this->prepareAndSendRequest(__FUNCTION__, get_defined_vars(), Sticker::class);
    }
