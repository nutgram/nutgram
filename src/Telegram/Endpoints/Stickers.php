...
trait Stickers
{
     ...
     * @param string $name Sticker set name
     * @param StickerType|string $format Format of the thumbnail, must be one of “static” for a .WEBP or .PNG image, “animated” for a .TGS animation, or “video” for a WEBM video
     * @param int|null $user_id User identifier of the sticker set owner
